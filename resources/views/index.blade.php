                                    ...
                                    <div id="carousel-post" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="item active">
                                                <a href="post_detail.html"><img src="{{asset("assets/img/post1.jpg")}}" alt="" /></a>
                                            </div>
                                            <div class="item">
                                                <a href="post_detail.html"><img src="{{asset("assets/img/post2.jpg")}}" alt="" /></a>
                                            </div>
                                            <div class="item">
                                                <a href="post_detail.html"><img src="{{asset("assets/img/post3.jpg")}}" alt="" /></a>
                                            </div>
                                        </div>
                                        <!-- end carousel-inner -->
                        ...
                        <li>
                            ...
                            <div class="post-content">
                                ...
                                <div class="post-image">
                                    <a href="post_detail.html"><img src="{{asset("assets/img/post4.jpg")}}" alt="" /></a>
                                </div>
                                <!-- end post-image -->
                                <!-- begin post-info -->
                                <div class="post-info">
