            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-hover tree_table" id="treeTable">
                        ...
                        <tr id="44" pid="1" class="1" previd="2" depth="2">
                            <td><span class="prev_span"><span class="vsStyle_node vsStyle_vertline"></span></span><span
                                        arrow="true" class="vsStyle_node vsStyle_leaf"></span>　<i class=""></i>55
                            </td>
                            <td>33</td>
                            <td>11</td>
                            <td>22</td>
                            <td><a href="#">
                                    <button type="button" class="btn btn-success btn-xs"><i class="fa fa-pencil"> 编辑</i>
                                    </button>
                                </a> <a href="javascript:;" data-id="3" class="btn btn-danger btn-xs destroy"><i
                                            class="fa fa-trash"> 删除</i>
                                    <form action="#" method="POST" name="delete_item_3" style="display:none"><input
                                                type="hidden" name="_method" value="DELETE"><input type="hidden"
                                                                                                   name="_token"
                                                                                                   value="jVCASDP4S3sHJ39X9Aqmo2ubCDC4EivA44lLKItG">
                                    </form>
                                </a></td>
                        </tr>
